...
require (
	...
	github.com/dymensionxyz/dymension-rdk v1.10.0-rc01
	github.com/dymensionxyz/dymint v1.5.0-rc02.0.20250911175730-3fa9e3bf881b
...
replace (
	github.com/CosmWasm/wasmd => github.com/dymensionxyz/wasmd v0.33.1-sdk0.46.2
