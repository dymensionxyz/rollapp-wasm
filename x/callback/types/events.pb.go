...
// source: rollapp/callback/v1/events.proto
...
func (*CallbackRegisteredEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_0debbd46abcdff3e, []int{0}
}
...
func (*CallbackCancelledEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_0debbd46abcdff3e, []int{1}
}
...
func (*CallbackExecutedSuccessEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_0debbd46abcdff3e, []int{2}
}
...
func (*CallbackExecutedFailedEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_0debbd46abcdff3e, []int{3}
}
...
func init() {
	proto.RegisterType((*CallbackRegisteredEvent)(nil), "rollapp.callback.v1.CallbackRegisteredEvent")
	proto.RegisterType((*CallbackCancelledEvent)(nil), "rollapp.callback.v1.CallbackCancelledEvent")
	proto.RegisterType((*CallbackExecutedSuccessEvent)(nil), "rollapp.callback.v1.CallbackExecutedSuccessEvent")
	proto.RegisterType((*CallbackExecutedFailedEvent)(nil), "rollapp.callback.v1.CallbackExecutedFailedEvent")
}

func init() { proto.RegisterFile("rollapp/callback/v1/events.proto", fileDescriptor_0debbd46abcdff3e) }

var fileDescriptor_0debbd46abcdff3e = []byte{
	...
	,
}
